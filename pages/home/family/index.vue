<template>
  <div class="home-detail-container">
    <div class="home-detail-wrapper" v-if="familyList.length">
      <div class="home-detail-list" v-for="(item,index) in familyList" :key="index">
        <div class="home-detail-item">
          ...
          <div class="item-content">
            ...
            <text>会见时间：{{ item.meetStartTime }}</text>
...
export default {
  ...
  methods: {
    ...
    async getFamilyList () {
      ...
      let res = await Api.apiCall("post", Api.index.getFamilyList, params);
